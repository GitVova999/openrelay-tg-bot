...
WELCOME = (
    ...
    "Что умею в приватке:\n"
    "• /summarize [часы] — саммари сообщений. По умолчанию за 24 часа. "
    "Пример: <code>/summarize 168</code> (за неделю)\n"
    "• /ask &lt;вопрос&gt; — ответ по контексту канала. "
    "Пример: <code>/ask что обсуждали про Base?</code>\n"
    "• /faq &lt;вопрос&gt; — быстрый ответ (можно и в канале)\n"
    "• /balance — баланс кошелька\n"
    "• /settings — настройки языка, тона, тематики (только владелец канала)\n"
    "• /help — этот список\n\n"
    "В канале: те же команды, короткий ответ пришлю сюда чтобы не засорять чат."
)
